        ...
        <section className="relative w-full py-10 px-4 md:px-8">
            <div className="max-w-9xl flex items-center justify-center flex-col">
                <motion.div
                    ...
                    className="relative w-full max-w-5xl aspect-[20/10] md:aspect bg-[#FFB566] rounded-[2rem] md:rounded-[3rem] overflow-hidden md:mb-12 shadow-2xl"
                >
                    <img
                        src={PodMic}
                ...
                <div className="w-full max-w-5xl grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-10 items-center">
                    ...
                    >
                        ...
                        <button className="w-fit flex items-center gap-2 px-6 py-2 hover:bg-white hover:text-black border-2 border-white rounded-lg text-white font-medium  transition-colors group">
                            Learn More
                            <svg
