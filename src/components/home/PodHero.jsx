    ...
    return (
        <section className="relative w-full pt-32  overflow-hidden">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center">
                ...
                >
                    <span className="text-6xl md:text-8xl lg:text-[10.5rem] font-lemon text-white font-bold tracking-tighter">P</span>

                    <motion.div
                        animate={{ rotate: -360 }}
                        transition={{ duration: 20, repeat: Infinity, ease: "linear" }}
                        className="w-16 h-16 md:w-24 md:h-24 lg:w-36 lg:h-36 relative mx-[-10px] md:mx-[-15px]"
                    >
                        <img
                            src={Moon}
                            alt="O"
                    ...
                    <span className="text-6xl md:text-8xl lg:text-[10.5rem] font-lemon text-white font-bold tracking-2">DCASTS</span>
                </motion.div>
